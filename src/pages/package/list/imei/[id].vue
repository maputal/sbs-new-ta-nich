...
const fetchImei = async () => {
  try {
    ...
    successMessage.value = "IMEI data loaded successfully"
    isSuccessToastVisible.value = true
  } catch (error) {
    errorMessage.value = error.message || "Failed to load IMEI data"
    isErrorToastVisible.value = true
  }
}

const deleteImei = (item = null) => {
  if (item) {
    itemToDelete.value = item
    confirmMessage.value = `Are you sure you want to delete this IMEI record?`
  } else {
    confirmMessage.value = `Are you sure you want to delete all selected IMEI records?`
  }
...
const confirmDelete = async () => {
  try {
    ...
    successMessage.value = "IMEI record(s) deleted successfully"
    isSuccessToastVisible.value = true
    itemToDelete.value = null
  } catch (error) {
    errorMessage.value = error.message || "Failed to delete IMEI record(s)"
    isErrorToastVisible.value = true
  }
}
