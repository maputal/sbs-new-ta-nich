...
const handleUploadSuccess = response => {
  successMessage.value = "TAC file uploaded successfully!"
  isSuccessToastVisible.value = true
}

const handleUploadError = error => {
  errorMessage.value = error.message || "Failed to upload TAC file. Please try again."
  isErrorToastVisible.value = true
}

const goBack = () => {
  router.push(`/package/list/tac/${packageId}`)
}
...
<template>
  <div class="package-activity-page">
    ...
    <VCard>
      ...
      <VCardText>
        <FileUploader
          file-upload-url="/ta_secure/package/import-tac"
